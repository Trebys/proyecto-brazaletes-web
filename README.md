...
Proyecto web para venta y gestion de brazaletes de parque de atracciones, con backend Django REST y frontend React.
...
Cada cambio importante debe dejar actualizados los documentos tecnicos afectados, los criterios de aceptacion o el registro de decisiones cuando corresponda.
