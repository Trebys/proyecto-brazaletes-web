...
Esta opcion carga los datos textuales sin reemplazar imagenes existentes por
rutas locales. El seed no sube archivos a la nube: las imagenes de la demo
publica deben cargarse desde el panel administrativo o mediante una estrategia
explicita de migracion de media. El flujo manual desde admin hacia Cloudinary
fue validado durante el despliegue.
